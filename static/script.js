...
var _snowDepth = _interopRequireDefault(require("./snowDepth"));

var _tempWindChart = _interopRequireDefault(require("./tempWindChart"));
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var prev10Metrics = ['temperature', 'wind_speed', 'wind_gust', 'wind_direction'];
  (0, _snowDepth.default)(chartGlobals);
  (0, _tempWindChart.default)(_objectSpread({}, chartGlobals, {
    metrics: prev10Metrics
  }));
});
"use strict";
...
var initSnowDepthChart = function initSnowDepthChart(_ref2) {
  ...
  d3.csv('https://s3.amazonaws.com/matthewparrilla.com/snowDepth.csv', transformRow, function (csv) {
    ...
    seasonSelect.onchange = function (_ref4) {
      var comparisonYear = _ref4.target.value;
      updateSnowDepthChart({
        data: data,
        line: line,
        seasonContainer: seasonContainer,
...
var _default = initSnowDepthChart;
...
var initPrev10Charts = function initPrev10Charts(_ref2) {
  var metrics = _ref2.metrics,
      width = _ref2.width,
      largeWidthThreshold = _ref2.largeWidthThreshold,
      height = _ref2.height,
      margin = _ref2.margin,
      fontSize = _ref2.fontSize;
  ...
  d3.csv('https://s3.amazonaws.com/matthewparrilla.com/mansfield_observations.csv', transformDate, function (unfilteredData) {
    ...
    .attr('height', containerHeight).attr('fill', 'none').attr('pointer-events', 'all').on('mouseout', function () {
      ...
      var bisect = d3.bisector(function (_ref3) {
